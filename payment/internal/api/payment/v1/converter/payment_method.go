...
func ProtoPaymentMethodToModel(paymentMethod paymentV1.PaymentMethod) model.PaymentMethod {
...
func ModelPaymentMethodToProto(paymentMethod model.PaymentMethod) paymentV1.PaymentMethod {
	switch paymentMethod {

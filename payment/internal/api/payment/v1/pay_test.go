...
func TestPayOrder(t *testing.T) {
	t.Run("Success", func(t *testing.T) {
		...
		mockPaymentService.EXPECT().
			Pay(ctx, orderUuid, userUuid, converter.ProtoPaymentMethodToModel(paymentMethod)).
	...
	t.Run("Unspecified payment method", func(t *testing.T) {
		...
		mockPaymentService.EXPECT().
			Pay(ctx, orderUuid, userUuid, converter.ProtoPaymentMethodToModel(req.PaymentMethod)).

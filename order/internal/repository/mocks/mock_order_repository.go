...
func (_mock *MockOrderRepository) CreateOrder(ctx context.Context, info *model.OrderInfo) (*uuid.UUID, error) {
	...
	var r0 *uuid.UUID
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, *model.OrderInfo) (*uuid.UUID, error)); ok {
		return returnFunc(ctx, info)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, *model.OrderInfo) *uuid.UUID); ok {
...
func (_c *MockOrderRepository_CreateOrder_Call) Return(uUID *uuid.UUID, err error) *MockOrderRepository_CreateOrder_Call {
	_c.Call.Return(uUID, err)
	return _c
}

func (_c *MockOrderRepository_CreateOrder_Call) RunAndReturn(run func(ctx context.Context, info *model.OrderInfo) (*uuid.UUID, error)) *MockOrderRepository_CreateOrder_Call {
	_c.Call.Return(run)
	return _c
}

...
func TestModelPaymentMethodToRepo(t *testing.T) {
	tests := []struct {
		name               string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			repoMethod := ModelPaymentMethodToRepo(tt.paymentMethod)
			if repoMethod != tt.expectedRepoMethod {
				t.Errorf("ModelPaymentMethodToRepo() = %v, want %v", repoMethod, tt.expectedRepoMethod)
			}
		})
	}
}

func TestRepoPaymentMethodToModel(t *testing.T) {
	tests := []struct {
		name                string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			modelMethod := RepoPaymentMethodToModel(tt.paymentMethod)
			if modelMethod != tt.expectedModelMethod {
				t.Errorf("RepoPaymentMethodToModel() = %v, want %v", modelMethod, tt.expectedModelMethod)
			}
		})
	}
}

func TestRepoOrderStatusToModel(t *testing.T) {
	tests := []struct {
		name                string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			modelStatus := RepoOrderStatusToModel(tt.status)
			if modelStatus != tt.expectedModelStatus {
				t.Errorf("RepoOrderStatusToModel() = %v, want %v", modelStatus, tt.expectedModelStatus)
			}
		})
	}
}

func TestModelOrderStatusToRepo(t *testing.T) {
	tests := []struct {
		name               string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			repoStatus := ModelOrderStatusToRepo(tt.status)
			if repoStatus != tt.expectedRepoStatus {
				t.Errorf("ModelOrderStatusToRepo() = %v, want %v", repoStatus, tt.expectedRepoStatus)
			}
		})
	}
}

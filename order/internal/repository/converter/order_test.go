...
func TestModelOrderInfoToRepoModel(t *testing.T) {
	tests := []struct {
		name     string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			actual := ModelOrderInfoToRepoModel(tt.info)
			assert.Equal(t, tt.expected, actual)
		})
	}
}

func TestModelOrderToRepoModel(t *testing.T) {
	tests := []struct {
		name     string
		order    *model.Order
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			actual := ModelOrderToRepoModel(tt.order)
			assert.Equal(t, tt.expected, actual)
		})
	}
}

func TestRepoModelOrderInfoToModel(t *testing.T) {
	tests := []struct {
		name     string
		info     *repoModel.OrderInfo
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			actual := RepoModelOrderInfoToModel(tt.info)
			assert.Equal(t, tt.expected, actual)
		})
	}
}

func TestRepoModelOrderToModel(t *testing.T) {
	tests := []struct {
		name     string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			actual := RepoModelOrderToModel(tt.order)
			assert.Equal(t, tt.expected, actual)
		})
	}
}

...
func ModelPaymentMethodToRepo(paymentMethod model.OrderPaymentMethod) repoModel.OrderPaymentMethod {
...
func RepoPaymentMethodToModel(paymentMethod repoModel.OrderPaymentMethod) model.OrderPaymentMethod {
	switch paymentMethod {
...
func RepoOrderStatusToModel(status repoModel.OrderStatus) model.OrderStatus {
	switch status {
...
func ModelOrderStatusToRepo(status model.OrderStatus) repoModel.OrderStatus {
	switch status {

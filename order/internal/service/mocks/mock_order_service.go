...
func (_mock *MockOrderService) CreateOrder(ctx context.Context, info *model.OrderInfo) (*uuid.UUID, error) {
...
func (_c *MockOrderService_CreateOrder_Call) Return(uUID *uuid.UUID, err error) *MockOrderService_CreateOrder_Call {
	_c.Call.Return(uUID, err)
	return _c
}

func (_c *MockOrderService_CreateOrder_Call) RunAndReturn(run func(ctx context.Context, info *model.OrderInfo) (*uuid.UUID, error)) *MockOrderService_CreateOrder_Call {
	_c.Call.Return(run)
	return _c
}

...
func ProtoPartDimensionsToModel(dim *inventoryV1.Dimensions) *model.PartDimensions {
...
func ModelPartDimensionsToProto(dim *model.PartDimensions) *inventoryV1.Dimensions {
...
func ModelPartToClient(part *model.Part) *inventoryV1.Part {

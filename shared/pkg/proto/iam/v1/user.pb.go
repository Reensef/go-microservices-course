...
type UserRegistrationInfo struct {
	...
	Info          *UserInfo              `protobuf:"bytes,1,opt,name=info,proto3" json:"info,omitempty"`         // Основная информация пользователя
...
const file_iam_v1_user_proto_rawDesc = "" +
	...
	"\x04info\x18\x01 \x01(\v2\x1c.iam.v1.UserRegistrationInfoR\x04info\"9\n" +

...
func (_mock *MockLogger) Error(ctx context.Context, msg string, fields ...zap.Field) {
	if len(fields) > 0 {
...
func (_c *MockLogger_Error_Call) Run(run func(ctx context.Context, msg string, fields ...zap.Field)) *MockLogger_Error_Call {
...
func (_c *MockLogger_Error_Call) RunAndReturn(run func(ctx context.Context, msg string, fields ...zap.Field)) *MockLogger_Error_Call {
	_c.Run(run)
	return _c
}

// Info provides a mock function for the type MockLogger
func (_mock *MockLogger) Info(ctx context.Context, msg string, fields ...zap.Field) {
	if len(fields) > 0 {
		_mock.Called(ctx, msg, fields)
	} else {
		_mock.Called(ctx, msg)
...
func (_c *MockLogger_Info_Call) Run(run func(ctx context.Context, msg string, fields ...zap.Field)) *MockLogger_Info_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockLogger_Info_Call) RunAndReturn(run func(ctx context.Context, msg string, fields ...zap.Field)) *MockLogger_Info_Call {
	_c.Run(run)
	return _c
}

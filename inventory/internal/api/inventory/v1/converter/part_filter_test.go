...
func TestProtoPartsFilterToModel(t *testing.T) {
	...
	modelFilter, err := ProtoPartsFilterToModel(protoFilter)
...
func TestProtoPartsFilterToModel_Nil(t *testing.T) {
	modelFilter, err := ProtoPartsFilterToModel(nil)
